...
<script type="text/javascript">
    // Preguntamos si el navegador soporta SW
    if ('serviceWorker' in navigator) {
        navigator.serviceWorker.register('/serviceworker.js', {
            scope: '.'
        }).then(function (registration) {
            // Registration was successful
            console.log('Laravel PWA: ServiceWorker registrado para url: ', registration.scope);
        }, function (err) {
            // registration failed :(
            console.log('Laravel PWA: ServiceWorker fallo al registrarlo por: ', err);
        });
    }
</script>
