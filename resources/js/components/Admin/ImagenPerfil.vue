    ...
    <div class="col-md-4">
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fas fa-user-circle"></i> Imagen de Perfil</h3>
            </div>
            <form class="form" content-type="multipart/form-data">
                <div class="box-body">
                    <div class="form-group">
                        <img class="img-responsive img-circle col-md-3 col-sm-2 col-2" height="100px" width="100px" v-bind:src="imagen">
                    </div>

                    <div class="form-group">
                        <div class="col-md-9 col-sm-10 col-10">
                            <input type="file" class="form-control" name="imagen" id="imagen" @change="imagenSeleccionada">
