          ...
          columns: [
            ...
            { data: "cumpleDia" },
            {
              render: function(data, type, row) {
                return (
                  '<i class="fab fa-whatsapp text-green"></i> <a href="https://wa.me/57' +
                  row.celular +
                  "?text=Hola, " +
                  row.nombre_completo +
                  ' " target="_blank" title="Enviar Mensaje">' +
                  row.celular +
                  "</a>"
                );
              }
            },
            {
              render: function(data, type, row) {
                return (
                  '<a class="btn btn-success btn-sm" href="https://wa.me/57' +
                  row.celular +
                  "?text=Hola, " +
                  row.nombre_completo +
                  ' " target="_blank" title="Enviar Mensaje"><i class="fab fa-whatsapp"></i> Enviar WhatsApp</a>'
                );
              }
            }
          ]
