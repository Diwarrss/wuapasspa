<template>
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <i class="fa fa-address-card" aria-hidden="true"></i> Mi Perfil <small>Información</small>
            </h1>
            <ol class="breadcrumb">
                <li>
                    <a href="/admin"><i class="fas fa-tachometer-alt"></i> Inicio</a>
                </li>
                <li class="active"><i class="fa fa-address-card" aria-hidden="true"></i> Mi Perfil</li>
            </ol>
        </section>
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            ...
                            <p class="text-muted text-center" v-if="estado_usuario == 1"><i class="fa fa-circle text-success"></i> Activo</p>
                            <p class="text-muted text-center" v-if="estado_usuario == 2"><i class="fa fa-circle text-danger"></i> Desactivado</p>

                            <ul class="list-group list-group-unbordered">
                                <li class="list-group-item">
                                <b>Nombres: </b> <span class="pull-right" v-text="nombre_usuario"></span>
                                </li>
                                <li class="list-group-item">
                                <b>Apellidos: </b> <span class="pull-right" v-text="apellido_usuario"></span>
                                </li>
                                <li class="list-group-item">
                                <b>E-mail: </b> <span class="pull-right" v-text="email"></span>
                                </li>
                                <li class="list-group-item">
                                <b>WhatsApp: </b> <span class="pull-right"><i class="fab fa-whatsapp text-green"></i> {{celular}}</span>
                                </li>
                                <li class="list-group-item">
                                <b>Fecha Cumpleaños: </b> <span class="pull-right" v-text="fecha_cumple"></span>
                                </li>
                                <li class="list-group-item">
                                <b>Foto Perfil: </b> <img class="img-responsive img-circle pull-right" height="25px" width="25px" v-bind:src="imagen">
                                </li>
                            </ul>
                            <button class="btn btn-primary" data-toggle="modal" data-target="#modalPerfil"><b><i class="fas fa-edit"></i> Editar</b></button>
                        </div>
                        <!-- /.box-body -->
                    </div>
                    <div class="box box-warning">
                        <div class="box-body box-profile">
                            <ul class="list-group list-group-unbordered">
                                <li class="list-group-item">
                                    <b>Creado el: </b> <span class="pull-right" v-text="created_at"></span>
                                </li>
                                <li class="list-group-item">
                                    <b>Última Modificación: </b> <span class="pull-right" v-text="updated_at"></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="box box-danger">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fas fa-user-secret"></i> Cambiar Contraseña</h3>
                        </div>
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8 col-xs-12">
                                        ...
                                        <p class="text-red" v-if="arrayErrors.password2" v-text="arrayErrors.password2[0]"></p>
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->
                    ...
                    <div class="modal-content">
                        <form class="form-horizontal">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title"><i class="fas fa-edit"></i> Actualizar Perfil</h4>
                            </div>
