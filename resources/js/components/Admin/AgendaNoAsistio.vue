<template>
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <i class="far fa-calendar-minus"></i> Citas no Asistidas <small>Información</small>
            </h1>
            <ol class="breadcrumb">
                <li>
                    <a href="/admin"><i class="fas fa-tachometer-alt"></i> Inicio</a>
                </li>
                <li class="active"> <i class="far fa-calendar-minus"></i> Citas no Asistidas</li>
            </ol>
        </section>
        <section class="content">
            <div class="box box-primary">
                ...
                <div class="table-responsive container-fluid">
                    <table id="tablaNoAsistio" class="table table-bordered table-hover" style="width:100%">
                        <thead>
                            <tr>
                                <th>Agendada el</th>
                                <th>Cliente</th>
        ...
        methods: {
            listarNoasistio(){
                ...
                jQuery(document).ready(function() {
                    var tablaNoAsistio = jQuery('#tablaNoAsistio').DataTable({
                        "language": {
                        ...
                        "columns": [
                                ...
                                {render: function (data, type, row) {
                                    if (row.estado_reservacion_nombre === 'No Asistió' && row.tipo_agenda == 'Sistema'){
