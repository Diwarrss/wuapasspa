      ...
      <div class="card">
        <div class="card-header">
          <div class="col-md-12 text-center">
            <h4>
              <i class="far fa-user text-primary"></i> Mi Perfil
            </h4>
          </div>
        </div>
        <div class="card-body">
          <div class="align-content-center">
            <img
              class="rounded-circle img-responsive mx-auto d-block"
              width="80px"
              height="80px"
              v-bind:src="imagen"
            />
    ...
    <div class="py-2">
      <div class="card">
        ...
        <div class="card-body">
          <form>
            <div class="form-group row">
              <label
                for="password"
                class="col-sm-5 col-form-label d-none d-sm-block"
        ...
        <div class="card-footer">
          ...
          <div v-else>
            <button type="button" class="btn btn-success pull-right" @click="actualizarPassword();">
