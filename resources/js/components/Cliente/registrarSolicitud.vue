    ...
    <div class="card">
      <div class="card-header">
        <div class="col-md-12 text-center">
          <h5>
            <i class="far fa-calendar-plus"></i> Solicitar Cita
          </h5>
        </div>
      </div>
      <div class="card-body">
        <form>
          ...
          <div class="form-group">
            <label for="servicios">
              <strong>
                <i class="fas fa-clipboard-list"></i> Elije tus Servicios
              </strong>
            </label>
            <select
          ...
          <div class="form-group">
            <label for="fecha_probable">
              <strong>
                <i class="far fa-clock"></i> Fecha y hora que prefieres
              </strong>
            </label>
            <datetime
              v-model="fecha_probable"
              type="datetime"
            ...
            <p
              class="text-danger"
              v-if="arrayErrors.fecha_probable"
              v-text="arrayErrors.fecha_probable[0]"
            ></p>
          </div>
          <div class="form-group">
            <label for="comentario">
              <strong>
                <i class="far fa-comment-alt"></i> Nota adicional
              </strong>
            </label>
            <textarea
              class="form-control"
...
export default {
  ...
  methods: {
    ...
    guardar() {
      var data = this;
      axios
        .post("/crearSolicitudesCliente", {
          fecha_probable: moment(data.fecha_probable).format(
            "YYYY-MM-DD HH:mm:ss"
