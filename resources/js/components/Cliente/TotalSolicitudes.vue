    ...
    <div class="card">
      <div class="card-header">
        <div class="card-title text-center">
          <h5>
            <i class="far fa-calendar-alt"></i> Historial de Citas
          </h5>
          <button @click="actualizarCitas()" class="btn btn-info btn-sm">
      ...
      jQuery(document).ready(function() {
            ...
            { data: "comentario" },
            {
              render: function(data, type, row) {
                if (row.estado_solicitud_nombre === "Agendada") {
                  return (
                    '<span class="badge badge-success mb-1 mr-sm-1">' +
                    row.estado_solicitud_nombre +
                    '</span><button type="button" class="btn btn-sm btn-info mb-1 mr-sm-1 verInformacion" title="Ver Información"><i class="far fa-question-circle"></i><span class="d-lg-none"> Info</span></button>'
                  );
                  ...
                  return (
                    '<span class="badge badge-warning mb-1 mr-sm-1">' +
                    row.estado_solicitud_nombre +
                    '</span><button type="button" class="btn btn-sm btn-info mb-1 mr-sm-1 verInformacion" title="Ver Información"><i class="far fa-question-circle"></i><span class="d-lg-none"> Info</span></button>'
                  );
                } else if (row.estado_solicitud_nombre === "Atendida") {
                  return (
                    '<span class="badge badge-light mb-1 mr-sm-1">' +
                    row.estado_solicitud_nombre +
                    "</span>"
                  );
                } else if (row.estado_solicitud_nombre === "No Asistió") {
                  return (
                    '<span class="badge badge-dark mb-1 mr-sm-1">' +
                    row.estado_solicitud_nombre +
                    "</span>"
                  );
                } else {
        ...
        tablatotalsolicitudes.on("click", ".verInformacion", function() {
          ...
          Swal.fire({
            ...
            html:
              datos["fecha_reserva"] + "<br><b>" + datos["Empleado"] + "</b>",
