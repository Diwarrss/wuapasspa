<template>
  <section>
    ...
    <aside v-if="roles_roles_id == 1" class="main-sidebar">
    ...
    <!-- MENU DEL EMPLEADO -->
    <aside v-if="roles_roles_id == 2" class="main-sidebar">
      <!-- sidebar: style can be found in sidebar.less -->
      <section class="sidebar">
        <!-- Sidebar user panel -->
        <div class="user-panel">
    ...
    <!-- MENU DEL AGENDADOR -->
    <aside v-if="roles_roles_id == 4" class="main-sidebar">
      <!-- sidebar: style can be found in sidebar.less -->
      <section class="sidebar">
        <!-- Sidebar user panel -->
        <div class="user-panel">
    ...
    <!-- si no hay ningun id de los anteriores -->
  </section>
</template>
<script>
export default {
